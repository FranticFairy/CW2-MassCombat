var Constructor = function()
{
    ...
    {
        // load sprites
        unit.loadSprite("FAI_HELIINF", false);
        unit.loadSprite("FAI_HELIINF+mask", true);
    };
    ...
    {
        return ["FAI_TRUCK","FAI_AMPHIBTRUCK","FAI_IFV","FAI_AMPHIBIFV","FAI_MECHINF","FAI_FOOTSOLDIER"];
    };
...
var FAI_HELIINF = new Constructor();
