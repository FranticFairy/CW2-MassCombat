var Constructor = function()
{
    ...
    {
        // load sprites
        unit.loadSprite("FAI_CARRIER", false);
        unit.loadSprite("FAI_CARRIER+mask", true);
    };
    ...
    {
        return ["FAI_FIGHTER","FAI_SEAPLANE","FAI_GUNSHIP","FAI_HELIINF","FAI_HELIVHC","FAI_TANKBUSTER","FAI_STEALTHFIGHTER"];
    };
...
var FAI_CARRIER = new Constructor();
