var Constructor = function()
{
    ...
    {
        sprite.loadSprite("FAI_STEALTHFIGHTER",  false, BATTLEANIMATION_FAI_STEALTHFIGHTER.getMaxUnitCount(), Qt.point(-5, 35));
        sprite.loadSprite("FAI_STEALTHFIGHTER+mask",  true, BATTLEANIMATION_FAI_STEALTHFIGHTER.getMaxUnitCount(), Qt.point(-5, 35));
    };
