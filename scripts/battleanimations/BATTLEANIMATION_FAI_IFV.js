var Constructor = function()
{
    ...
    {
        sprite.loadSprite("FAI_IFV",  false, BATTLEANIMATION_FAI_IFV.getMaxUnitCount(), Qt.point(-5, 5));
        sprite.loadSprite("FAI_IFV+mask",  true, BATTLEANIMATION_FAI_IFV.getMaxUnitCount(), Qt.point(-5, 5));
    };
