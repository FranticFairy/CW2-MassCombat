var Constructor = function()
{
    ...
    {
        sprite.loadSprite("FAI_TANK_LIGHT",  false, BATTLEANIMATION_FAI_TANK_LIGHT.getMaxUnitCount(), Qt.point(-5, 5));
        sprite.loadSprite("FAI_TANK_LIGHT+mask",  true, BATTLEANIMATION_FAI_TANK_LIGHT.getMaxUnitCount(), Qt.point(-5, 5));
    };
