var Constructor = function()
{
    ...
    {
        sprite.loadSprite("FAI_PLANE_TANKBUSTER",  false, BATTLEANIMATION_FAI_PLANE_TANKBUSTER.getMaxUnitCount(), Qt.point(-5, 35));
        sprite.loadSprite("FAI_PLANE_TANKBUSTER+mask",  true, BATTLEANIMATION_FAI_PLANE_TANKBUSTER.getMaxUnitCount(), Qt.point(-5, 35));
    };
